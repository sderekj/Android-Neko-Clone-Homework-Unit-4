...
public class Bunny {
    ...
    public Bunny(String name, Long lastFed, int bunnyIcon, int bunnyNumber, int bunnyFood) {
        this.name = name;
        this.lastFed = lastFed;
        this.bunnyIcon = bunnyIcon;
        this.bunnyNumber = bunnyNumber;
        this.bunnyFood = bunnyFood;
...
//        }
    ...
    public int getBunnyFood() {
        return bunnyFood;
    }

    public void setBunnyFood(int bunnyFood) {
        this.bunnyFood = bunnyFood;
    }
}
